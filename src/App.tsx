...
const CoupletDisplay = () => {
	const { displayLeftText, displayRightText, fontSize } = useCoupletSync(
		"信步醉酒月初圓",
		"和風拂柳春將至",
	);
	...
	return (
		<div className="flex h-screen bg-red-600 p-4">
			{/* Left column - 20% */}
			<div className="w-[18%] flex items-center justify-center relative">
				{fireworksEnabled && (
					<Fireworks
		...
		<div className="min-h-screen bg-red-600 p-4 overflow-auto">
			<div className="max-w-4xl mx-auto">
				...
				<div className="bg-red-700 rounded-lg p-6 mb-8">
					<div className="mb-6">
						<label
							className="block text-yellow-300 text-lg mb-2"
							style={{ fontFamily: "'Noto Serif TC', serif" }}
						>
							字體大小：
						</label>
						<div className="flex items-center gap-4">
							...
							/>
							<span
								className="text-yellow-300 min-w-16"
								style={{ fontFamily: "'Noto Serif TC', serif" }}
							>
								{fontSize}px
							</span>
				...
				<div className="bg-red-700 rounded-lg p-6">
					<h2
						className="text-yellow-300 text-2xl mb-4"
						style={{ fontFamily: "'Noto Serif TC', serif" }}
					>
						已儲存的預設
					</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						{presets.map((preset: any) => (
							<div
								key={preset.id}
								className="bg-red-800 rounded-lg p-4 flex flex-col"
							>
								<h3
									className="text-yellow-300 text-xl mb-2"
									style={{ fontFamily: "'Noto Serif TC', serif" }}
								>
									{preset.name}
								</h3>
